...
硬约束见 [architecture rule](../rules/architecture.mdc)（WhatsFeed：Nest / Next / Expo）。

## 项目说明

本仓库为 **WhatsFeed** monorepo（非 explore-ai Java/Angular）。编排时按本仓技能与架构执行；`angular-*` / `spring-ai` skills 仅作参考。
