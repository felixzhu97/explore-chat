...
| 2 | Vendor / lab **research** + open-source | [business-tech-analysis sources](../business-tech-analysis/references/sources.md) |
| 3 | **arXiv** papers (abs page) | [arXiv](https://arxiv.org/) |
...
For model, benchmark, ASR / TTS / LLM, RAG, agent, or algorithm-related changes, when these source types exist, include them in both the commit and the PR:

1. One **academic** source (arXiv abs or official paper)
2. One **Hugging Face** model/collection/paper page
3. One official **vendor blog** / release note
4. Upstream **GitHub** or official implementation docs
