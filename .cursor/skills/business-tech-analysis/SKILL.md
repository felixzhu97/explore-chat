...
4. Tie advice to **this repo’s capabilities** when analyzing WhatsFeed (social feed, Nest BFF, Ollama, explore-ai proxy, Python RAG/vision/recommendation) — or state clearly if the analysis is industry-generic.
...
- Fit with existing stack (NestJS, Next/Expo, Ollama, explore-ai BFF, Qdrant RAG, recommendation)
...
| Architecture constraints | [architecture rule](../../rules/architecture.mdc) |
