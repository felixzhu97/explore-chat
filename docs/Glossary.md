...
| Image Gen      | 图片生成        | `com.chat.ai` → explore-ml image-playground | `ai/apis/image.api`  | —                                  | 生成对话框       | `/api/v1/images:generate`       | API → explore-ml `:8003`                         |
| Video Gen      | 视频生成        | `com.chat.ai` → explore-ml video | `ai/apis/video.api`  | —                                  | 生成对话框       | `/api/v1/videos:generate`       | API → explore-ml `:8005`                         |
| Voice Gen      | 语音合成        | `com.chat.ai` → explore-ml speech | `ai/apis/voice.api`  | —                                  | 生成对话框       | `/api/v1/voices:synthesize`     | API → explore-ml `:8004`                         |
