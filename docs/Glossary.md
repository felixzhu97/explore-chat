...
| Image Gen      | 图片生成        | `com.chat.ai` → media-gen        | `ai/apis/image.api`  | —                                  | 生成对话框       | `/api/v1/image`                 | API → media-gen                                  |
| Video Gen      | 视频生成        | `com.chat.ai` → media-gen        | `ai/apis/video.api`  | —                                  | 生成对话框       | `/api/v1/video`                 | API → media-gen                                  |
| Voice Gen      | 语音合成        | `com.chat.ai` → media-gen        | `ai/apis/voice.api`  | —                                  | 生成对话框       | `/api/v1/voice`                 | API → media-gen                                  |
| Vision         | 视觉审核        | `com.chat.ai` → vision           | `ai/apis/vision.api` | —                                  | 发帖链路         | `/api/v1/vision`                | 旁路 Vision 服务                                 |
